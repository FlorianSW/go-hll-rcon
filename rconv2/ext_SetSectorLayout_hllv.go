...
func (c *HLLVConnection) SetSectorLayoutBySlice(ctx context.Context, sectors []string) error {
	r := HLLVSetSectorLayout{}
	...
	_, err := execCommand[HLLVSetSectorLayout, any](ctx, c.socket, r)
	return err
}
